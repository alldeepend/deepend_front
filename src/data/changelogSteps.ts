...
export const CHANGELOG_STEPS: ChangelogStep[] = [
    ...
    },
    {
        ...
        text: 'La primera impresión de DeepEnd tiene diseño nuevo. Como ya tienes cuenta no la ves seguido, así que te la mostramos aquí.',
    },
    {
        type: 'spot',
        target: '#landing-testimonials',
        side: 'left',
        route: '/landing',
        icon: Mic,
        eyebrow: 'Comunidad',
